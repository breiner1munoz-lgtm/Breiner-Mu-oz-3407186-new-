...
const descriptionIsRelevant = entityDescription.includes("guitarra");
...
const mainCard = `
${separator}
  ${DOMAIN_NAME.toUpperCase()} — 3407186-11
${separator}
...
console.log(`¿Descripción contiene 'guitarra'?: ${descriptionIsRelevant}`);

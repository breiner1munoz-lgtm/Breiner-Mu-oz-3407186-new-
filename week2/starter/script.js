...
const DOMAIN_NAME = "Instrumentos Musicales - Piano";
...
const itemName = "Piano de Cola Steinway D-274";
...
const itemCategory = "Instrumento de Teclado de Concierto";
...
const itemQuantity = 88; // Número de teclas del piano
...
const isItemAvailable = true; // Piano disponible para conciertos
...
const nextMaintenanceDate = null; // Aún sin agendar
...
console.log(`Teclas:    ${itemQuantity}`);
...
const teclasComoTexto = String(itemQuantity);
console.log("Número de teclas como texto:", teclasComoTexto);
console.log("typeof (convertido a texto):", typeof teclasComoTexto);
...
console.log("Próximo mantenimiento:", nextMaintenanceDate);
// TODO: Agrega typeof y la verificación === null
console.log("typeof nextMaintenanceDate:", typeof nextMaintenanceDate);    // "object" ← bug histórico
console.log("¿Es null?:", nextMaintenanceDate === null);    // true
console.log("");

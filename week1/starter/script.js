...
console.log('=========================================');
console.log('TIENDA DE INSTRUMENTOS MUSICALES - 3407186');
console.log('=========================================');
console.log('');
...
console.log('--------------------');
console.log('Nombre:          Piano');
console.log('Código:          00-2');
console.log('Categoría:       Percusión');
console.log('Estado:          Activo');
...
console.log('Valor principal:    150000');
...
console.log('Valor calculado:    ', 150000 * 0.8); // precio con 10% de descuento
...
console.log('¡Disfruta la música con JavaScript!');
